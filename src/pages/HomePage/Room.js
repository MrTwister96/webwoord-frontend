...
const Room = ({
    ...
    return (
        <button
            ...
            className="flex items-center w-11/12 md:w-3/5 lg:w-2/5 py-2 bg-gray-800 bg-opacity-80 justify-between rounded-lg transition-all duration-200 ease-linear hover:bg-gray-700 hover:bg-opacity-60 outline-none focus:ring-4 focus:ring-secondary"
        >
